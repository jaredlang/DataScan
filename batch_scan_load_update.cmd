...
python H:\MXD_Scan\make_mxd_batch_cmd.py -a update -b H:\MXD_Scan\xlsx\arcgis_files\batch_update_missed_mxds.cmd -s H:\MXD_Scan\xlsx\arcgis_files\update_mxds_missed_files_NEW.txt

echo MXD(missed) UPDATE script START %date% %time%
call H:\MXD_Scan\xlsx\arcgis_files\batch_update_missed_mxds.cmd > H:\MXD_Scan\xlsx\arcgis_files\update_mxds_missed.log 2>&1
